 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\AdminUserNotification[] $adminUserNotifications
...
class AdminUser extends AuthenticatableBase
{
    ...
    {
        return $this->hasMany(\App\Models\AdminUserNotification::class, 'admin_user_id', 'id');
    }
